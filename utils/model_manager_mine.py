...
def init_pretrained_weights(model):
    ...
    pretrain_dict = torch.load(r'/home/wuzhiyue/PycharmProjects/AlignedCC-ReID/imagenet/resnet50-19c8e357.pth')
    # pretrain_dict = torch.load(r'/home/wuzhiyue/PycharmProjects/AlignedCC-ReID/imagenet/pcb_seg_prcc_hp.pth')
...
class PCB_seg(nn.Module):

    def __init__(self,num_classes):
        super(PCB_seg,self).__init__()
